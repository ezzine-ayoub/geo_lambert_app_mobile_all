                        ...
                        try:
                            ...
                            if include_missing:
                                ...
                                try:
                                    ...
                                    _logger.info(
                                        f"📝 Found {len(missing_records)} missing records (not in provided list)")
                                    ...
                                    if missing_records:
                                        ...
                                        total_result_objects += len(
                                            missing_data)  # ✨ NOUVEAU: Mise à jour du compteur global
                                        _logger.info(
                                            f"🎯 Added {len(missing_data)} missing objects to result (total result objects: {total_result_objects})")

                                        # ✨ NOUVEAU: Vérifier si on a atteint la limite après avoir ajouté les objets manquants
                                        if limit is not None and total_result_objects >= limit:
                                            limit_reached = True
                                            _logger.info(
                                                f"🎯 LIMIT REACHED after adding missing objects for '{model_name}' ({total_result_objects}/{limit})")
                                    else:
